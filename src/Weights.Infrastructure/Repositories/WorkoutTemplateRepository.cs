...
public class WorkoutTemplateRepository : Repository<WorkoutTemplate, int>, IWorkoutTemplateRepository
{
    public WorkoutTemplateRepository(ApplicationDbContext context) : base(context)
    {
    }
